...
if (!themeDisplay.isSignedIn() && layout.isPublicLayout()) {
	...
	//Custom source
	String customCanonicalUrl = completeURL;
	int queryStringIndex = customCanonicalUrl.indexOf(StringPool.QUESTION);
	if(queryStringIndex > 0) {
		customCanonicalUrl = customCanonicalUrl.substring(0,queryStringIndex);
	} //End custom source
%>
	...
	--%>
	<link href="<%= HtmlUtil.escapeAttribute(customCanonicalUrl) %>" rel="canonical" />
