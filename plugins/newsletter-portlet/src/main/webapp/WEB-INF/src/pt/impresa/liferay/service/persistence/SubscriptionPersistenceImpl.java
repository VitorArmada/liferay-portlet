...
import pt.impresa.liferay.NoSuchSubscriptionException;
import pt.impresa.liferay.model.Subscription;
import pt.impresa.liferay.model.impl.SubscriptionImpl;
import pt.impresa.liferay.model.impl.SubscriptionModelImpl;
...
public class SubscriptionPersistenceImpl extends BasePersistenceImpl<Subscription>
	...
	protected Subscription toUnwrappedModel(Subscription subscription) {
		...
		subscriptionImpl.setName(subscription.getName());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.pt.impresa.liferay.model.Subscription")));
